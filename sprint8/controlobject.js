...
// When the mouse releases from the mouse pad, so your finger is being lifted up
    mUp(e){
        ...
        if(this.drag == true){
            ...
            // Star
            else if(Buttons.shape_name == "4 points"){
                var temp = new Star(this.xMouseStart, this.yMouseStart, this.w, this.h, 4, Colourgrid.colours);
                this.object_set.push(temp);
            }
            else if(Buttons.shape_name == "5 points"){
                var temp = new Star(this.xMouseStart, this.yMouseStart, this.w, this.h, 5, Colourgrid.colours);
                this.object_set.push(temp);
            }
            else if(Buttons.shape_name == "6 points"){
                var temp = new Star(this.xMouseStart, this.yMouseStart, this.w, this.h, 6, Colourgrid.colours);
                this.object_set.push(temp);
            }
            else if(Buttons.shape_name == "7 points"){
                var temp = new Star(this.xMouseStart, this.yMouseStart, this.w, this.h, 7, Colourgrid.colours);
                this.object_set.push(temp);
            }

            // Hexagon
            else if(Buttons.shape_name == "3 sides"){
                var temp = new Hexagon(this.xMouseStart, this.yMouseStart, this.w, this.h, 3, Colourgrid.colours);
                this.object_set.push(temp);
            }
            else if(Buttons.shape_name == "4 sides"){
                var temp = new Hexagon(this.xMouseStart, this.yMouseStart, this.w, this.h, 4, Colourgrid.colours);
                this.object_set.push(temp);
            }
            else if(Buttons.shape_name == "5 sides"){
                var temp = new Hexagon(this.xMouseStart, this.yMouseStart, this.w, this.h, 5, Colourgrid.colours);
                this.object_set.push(temp);
            }
            else if(Buttons.shape_name == "6 sides"){
...
// update function
    ...
    // finds out what the width and height measurements are, using xMouse/yMouse and the 2 startpoints
        ...
        if(this.drag){
            // Brush code
            if(circleButton.selected == "B1"){
                this.object_set.push(new Ellipse(this.xMouse, this.yMouse, 10, 10, Colourgrid.colours));
            }
            else if(circleButton.selected == "B2"){
                this.object_set.push(new Ellipse(this.xMouse, this.yMouse, 20, 20, Colourgrid.colours));
            }
            else if(circleButton.selected == "B3"){
                this.object_set.push(new Ellipse(this.xMouse, this.yMouse, 30, 30, Colourgrid.colours));
            }
